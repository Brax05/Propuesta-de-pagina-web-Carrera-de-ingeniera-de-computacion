    ...
    <div className="min-h-screen flex flex-col bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed">
                Formamos profesionales con sólidos fundamentos en ciencias de la
                computación, capaces de diseñar, desarrollar y gestionar
                soluciones tecnológicas que aporten al desarrollo de la región y
                país.
              </p>
              <ul className="space-y-4 text-gray-300 mb-8">
                <li className="flex gap-3">
                  ...
                  <span>
                    Líneas: Ingeniería de software, inteligencia artificial,
                    ciencia de datos, redes y ciberseguridad.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-blue-400 font-bold">•</span>
                  <span>
                    Apoyo a carreras de ingeniería, ciencias y programas de
                    postgrado de la ULS.
                  </span>
                </li>
                <li className="flex gap-3">
                  <span className="text-blue-400 font-bold">•</span>
                  <span>
                    Vinculación con la industria, proyectos estudiantiles y
                    trabajo colaborativo con el entorno regional.
                  </span>
                </li>
              </ul>
              <Link to="/contacto">
            ...
            <div className="bg-white rounded-lg p-10 text-center shadow-xl">
              ...
              <div className="mt-8 space-y-3 text-left text-gray-700 text-sm">
                <p>
                  <strong>Grado Académico:</strong> Bachiller en Ciencias de la
                  Ingeniería / Licenciado(a) en Ciencias de la Ingeniería
                </p>
                <p>
                  <strong>Título Profesional:</strong> Ingeniero(a) Civil en
                ...
                <p>
                  <strong>Régimen de Estudios:</strong> Semestral
                </p>
                <p>
                  <strong>Arancel anual 2025:</strong> $4.105.000
                </p>
              </div>
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 text-sm">
                    {i === 1
                      ...
                      : "Mantente atento a nuestras actividades."}
                  </p>
                  {i < 3 && (
                    <Link
                      to="#"
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {["Juanito Rodriguez", "Carlita Flores", "Camilito Bugz"].map(
              (name, i) => (
                <div
                  key={i}
