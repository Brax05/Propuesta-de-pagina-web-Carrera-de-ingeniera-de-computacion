...
export default function GestionUsuarios() {
  const [users, setUsers] = useState<User[]>([
    { id: 1, email: "admin@userena.cl", firstName: "Juan", lastName: "Pérez", role: "admin", isCECMember: false },
    { id: 2, email: "editor@userena.cl", firstName: "María", lastName: "González", role: "editor", isCECMember: true, cecPosition: "Secretaria" },
    { id: 3, email: "estudiante@userena.cl", firstName: "Carlos", lastName: "Rojas", role: "student", isCECMember: true, cecPosition: "Tesorero" },
  ]);
  ...
  const handleAddUser = () => {
    ...
    setUsers([...users, user]);
    setNewUser({ email: "", firstName: "", lastName: "", role: "student", isCECMember: false, cecPosition: "" });
    setIsAdding(false);
  };
